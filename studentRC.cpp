 ...
 * studentRC.cpp
 *
 * Copyright 2018 Korey Criggler-Calamease <crigglerk@Conquerer743>
 *
...
void student::getdata()
{
   ...
   cin>>c_grade;
   cout<<"\nEnter The grade in Math out of 100 : ";
   cin>>m_grade;
...
{
   cout<<rollno<<setw(6)<<" "<< "\t" << name<< "\t"<<p_grade<<setw(4)<<c_grade<<setw(4)<<m_grade<<setw(4)
      <<e_grade<<setw(4)<<cs_grade<<setw(8)<<per<<setw(6)<<grade<<endl;
}
...
void intro()
{
   ...
   cout<<"\n\n\t\tREPORT CARD";
   cout<<"\n\n\t\t  PROJECT";
   cout<<"\n\n\n\tMADE BY : Korey Criggler-Calamease";
   cin.get();
}
